<template>
  <div class="main-page">
    <section class="main-page__gnb">
      ...
      <a class="participate-survey" :href="main.surv_url" target="_blank">설문 참여하기 <i class="el-icon-right" /> </a>
    </section>
    ...
    <section class="main-page__suggests">
      <h3>실현된 제안</h3>
      <swiper
        class="suggest-swiper"
        :options="swiperOption"
      >
        <swiper-slide v-for="realize in main.realizedPropoList" :key="realize.idx">
          <div class="box">
            <div class="title">
              <div class="category">
